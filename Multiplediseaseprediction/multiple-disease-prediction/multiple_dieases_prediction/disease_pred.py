...
diabetes_model = pickle.load(open(r'C:\Users\Varun\OneDrive\Documents\Multiplediseaseprediction\multiple-disease-prediction\multiple_dieases_prediction\saved models\diabetes_model.sav','rb'))
heart_disease_model = pickle.load(open(r'C:\Users\Varun\OneDrive\Documents\Multiplediseaseprediction\multiple-disease-prediction\multiple_dieases_prediction\saved models\heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open(r'C:\Users\Varun\OneDrive\Documents\Multiplediseaseprediction\multiple-disease-prediction\multiple_dieases_prediction\saved models\parkinsons_model.sav','rb'))
autism_model = pickle.load(open(r'C:\Users\Varun\OneDrive\Documents\Multiplediseaseprediction\multiple-disease-prediction\multiple_dieases_prediction\saved models\autism_model (1).sav','rb')) 
